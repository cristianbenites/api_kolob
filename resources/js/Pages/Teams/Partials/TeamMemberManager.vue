            ...
            <jet-form-section @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <div class="col-span-6 lg:col-span-4" v-if="availableRoles.length > 0">
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer dark:border-gray-400">
                            <button type="button" class="relative inline-flex w-full px-4 py-3 rounded-lg focus:z-10 focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200"
                                            :class="{'border-t border-gray-200 rounded-t-none dark:border-gray-400': i > 0, 'rounded-b-none': i != Object.keys(availableRoles).length - 1}"
                ...
                <template #actions>
                    ...
                    <jet-button :class="{ 'opacity-25 dark:opacity-50': addTeamMemberForm.processing }" :disabled="addTeamMemberForm.processing">
                        Add
                    </jet-button>
                </template>
            </jet-form-section>
